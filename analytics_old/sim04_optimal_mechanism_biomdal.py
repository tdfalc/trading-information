...
def main():
    ...
    threshold_indices = np.arange(450, 580).astype(int)
    ...
    #     tau, prob_state0, threshold_index, multi=multiplier, virtual_values=virtual_values
    # )

    # ms = []
    # objs = []
    # for m in np.linspace(-20, 20, 100):
    #     (
    #         *_,
    #         o,
    #         _,
    #         _,
    #     ) = mechanism.solve_virtuals2(
    ...
    # # ax.plot(midpoints, all_virtuals, color="darkorange")
    # # ax.plot(midpoints, binaries2, color="magenta")
    # ax.set_ylabel(r"Allocation ($\xi_j$)")
    # ax.set_xlabel("Private Type ($t_i$)")
    # fig.tight_layout()
    ...
    # virtuals = VirtualValues(dist, midpoints, tau, prob_state0, iron=True)
    # ax.plot(
    #     midpoints,
    #     virtuals.negative,
    #     color="blue",
    ...
    # ax2 = ax.twinx()
    # ax2.plot(midpoints, allocations, color="darkorange")
    ...
    # print(allocations_vv[30:60])
    # print(virtuals.negative[30:60])
